...
<section style="padding:80px 0px;background-color: #e9eeef91;">
	<div class="container">	
		...
		<div class="col-lg-10 col-md-10 col-sm-12  categoryBoxes">
			<p style="padding-top: 20px;">You Searched for "<strong>What is DBMS?</strong>"</p>
			...
			<div class="row">
				<!-- <div class="col-lg-12 col-md-12 col-sm-12">
					...
					<p style="color:grey;">Uploaded By: KuntalSarkar &nbsp; &nbsp; Category: DBMS <span class="datestyle" style="font-size: 15px;">Views: 10</span></p>
					<hr>
				</div> -->
				<?php
					foreach($categoryQuestions as $row){
						echo '<div class="col-lg-12 col-md-12 col-sm-12">
								...
								<p style="color:grey;">Uploaded By: <a href="'.base_url().$row['UserName'].'">@'.$row['UserName'].'</a> &nbsp; &nbsp; Category: <a href="'.base_url().'Category/'.$row['CategoryName'].'">'.$row['CategoryName'].'</a> <span class="datestyle" style="font-size: 15px;"><span class="glyphicon glyphicon-eye-open"></span> '.$row['Views'].'</span></p>
								<hr>
							</div>';
					}
				?>
