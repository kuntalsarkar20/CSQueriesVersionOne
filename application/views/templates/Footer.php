			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12" style="padding:30px;">
						<div class="row" style="box-shadow: -2px 16px 11px 2px rgba(149,139,139,0.62);background-color:#0d0d0d;border-radius: 50px 0px 50px 0px;">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<p style="color: white;text-align: center;background-color: rgba(65, 89, 73, 0.21);padding:10px;border-radius: 25px 0px 30px 0px;">&copy;<span >2020 All Rights Reserved.</span> &nbsp; &nbsp; <a href="<?php echo base_url(); ?>MeetTheDevelopers" class="footer-links">Meet The Developers</a></p>
					</div>
				</div>
			</div>
			</div>
