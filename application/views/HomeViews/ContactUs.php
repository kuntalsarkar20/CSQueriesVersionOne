		...
		<div class="col-lg-8 col-md-8 col-sm-12 categoryBoxes">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12" style="padding: 50px 10px;">
					<h4 style="text-align: center;">Fill the Below Form & describe us your issue. We will love to hear it from you.</h4><br>
					<form class="form-horizontal">
					    ...
					    <br>
					      <div class="col-sm-offset-2 col-sm-8 input-group">
					    	...
					    	<br>
				    	<div class="col-sm-offset-2 col-sm-8 input-group" style="text-align: center;"><button type="submit" class="contactus-button">Submit</button></div>
				 	 </form>
				 </div>
			</div>
		</div>
