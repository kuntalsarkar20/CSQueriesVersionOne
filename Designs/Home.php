	...
	<div class="container" style="padding: 20px 0px 50px 0px;">
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
				<div class="card">
				  <img src="write_for_us_2.png" alt="John" style="width:100%;height:200px;">
				  <h3>Write For Us</h3>
			...
			<div class="col-lg-4 col-md-4 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
				<div class="card">
				  <img src="having_doubts.png" alt="John" style="width:100%">
				  <h3>Having Doubts?</h3>
			...
			<div class="col-lg-3 col-md-3 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
				<div class="card">
				  <img src="search_here.png" alt="John" style="width:100%">
