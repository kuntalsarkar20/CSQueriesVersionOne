<section  style="background: linear-gradient(123deg,#6a89cc,#b8e994);padding:;background-size: 100% 100%;min-height:800px;padding:80px 0px;">
<div class="container">
  <div class="row" style="padding:12% 0px;">
